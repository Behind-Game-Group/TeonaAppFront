      ...
      >
        <SafeAreaView style={styles.container}>
          ...
          <Text style={styles.allowText}>
            Your location will be displayed on the map and will be used in order
            to provide itineraries, travel time estimates and easy proximity
            searches. {'\n'}
            {'\n'}{' '}
          </Text>

          <View style={styles.allowMapContainer}>
            <TeoMap htmlFilePath={htmlFilePath} />
          </View>
        </SafeAreaView>
      </ImageBackground>
    </SafeAreaProvider>
